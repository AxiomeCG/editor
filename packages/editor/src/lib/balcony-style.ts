...
import { type BalconyOptions, balconyGuard, DEFAULT_BALCONY } from '@pascal-app/core/building'
import { type BalconyEdge, exposedBalconyEdges } from '@pascal-app/core/building'
